...
public class Admin extends JFrame {
	...
	public Admin() {
		...
		main.setBounds(4, 3, 250, 215);
		contentPane.add(main);
		main.setLayout(null);
		
		JLabel mainlbl = new JLabel("");
		mainlbl.setBounds(56, 5, 95, 35);
		main.add(mainlbl);
		
		JLabel userlbl = new JLabel("Username");
		userlbl.setBounds(36, 56, 86, 25);
		main.add(userlbl);
		
		userText = new JTextField();
		userText.setBounds(135, 58, 86, 20);
		main.add(userText);
		...
		passlbl.setBounds(36, 92, 65, 25);
		main.add(passlbl);
		
		passText = new JPasswordField();
		passText.setBounds(135, 92, 86, 20);
		...
		homeBtn.setBounds(150, 161, 89, 23);
		main.add(homeBtn);
		fload();
	}
	public void fload()
